...
RUSTHOST=${CHOST%%-*}-unknown-linux-musl

RUST_STAGE0_VERSION="1.31.0"

DESCRIPTION="Systems programming language from Mozilla"
HOMEPAGE="https://www.rust-lang.org/"

SRC_URI="https://static.rust-lang.org/dist/${SRC} -> rustc-${PV}-src.tar.xz
			https://portage.smaeul.xyz/distfiles/rust-1.31.0-x86_64-unknown-linux-musl.tar.xz"
...
src_prepare() {
	...
	local rust_stage0="rust-${RUST_STAGE0_VERSION}-x86_64-unknown-linux-musl"

	"${WORKDIR}/${rust_stage0}"/install.sh \
		--destdir="${rust_stage0_root}" \
		--prefix=/ \
		--disable-ldconfig \
		--components=rust-std-x86_64-unknown-linux-musl,rustc,cargo \
		|| die
...
src_configure() {
	...
	for v in "1"; do
		rust_target="x86_64-unknown-linux-musl"
		arch_cflags="$(get_abi_CFLAGS 'x86_64')"
