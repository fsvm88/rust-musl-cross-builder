...
RUST_STAGE0_VERSION="1.31.1"

DESCRIPTION="Systems programming language from Mozilla"
HOMEPAGE="https://www.rust-lang.org/"

SRC_URI="https://static.rust-lang.org/dist/${SRC} -> rustc-${PV}-src.tar.xz
		https://portage.smaeul.xyz/distfiles/rust-1.31.1-x86_64-unknown-linux-musl.tar.xz"
...
rust_cust_abi="x86_64-unknown-linux-musl"
...
src_configure() {
	local rust_target="$rust_cust_abi" rust_targets="\"$rust_cust_abi\"" arch_cflags
